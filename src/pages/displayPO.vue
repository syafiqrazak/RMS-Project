    ...
    <form>
      ...
      <md-card-content>
          <table style="width:100%" >
               ...
               <div >
                    <md-table style="width:100%" v-model="item" :md-sort.sync="currentSort" :md-sort-order.sync="currentSortOrder" :md-sort-fn="customSort" md-card>
                    ...
                    <md-table-row slot="md-table-row" slot-scope="{ item }">
                        ...
                        <md-table-cell md-label="Total Price" ><b>RM {{ item.quantity * item.price }}</b></md-table-cell>
                    </md-table-row>
                    </md-table>
                </div>
...
export default {
  ...
  data() {
    return {
      ...
      address: 'A1-L2-2 Pantai Hillpark Phase 1, Pantai Hillpark, 59200 Kuala Lumpur',
      to: 'Mr Adnan Azhar',
      total: 0,
      item: [
          {
